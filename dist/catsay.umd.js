(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('string-width')) :
  typeof define === 'function' && define.amd ? define(['exports', 'string-width'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.catsay = {}, global.stringWidth));
})(this, (function (exports, stringWidth) { 'use strict';
  ...
  function computeBreakPoint(text) {
    if (text.indexOf('\n') > 0) {
      return numberArrayMax(text.split('\n').map(function (it) {
        return stringWidth__default["default"](it);
      }));
    }

    if (stringWidth__default["default"](text) < 40) {
  ...
  function getTextList(text, breakPoint) {
    ...
    lists.forEach(function (element) {
      ...
      if (stringWidth__default["default"](textList[nextIndex]) > breakPoint) {
        nextIndex += 1;
      }
    });
    return textList;
  ...
  function border(textList, breakPoint) {
    ...
    textList.forEach(function (it) {
      result.push('│' + generateChar(' ', padding) + it + generateChar(' ', breakPoint - stringWidth__default["default"](it)) + generateChar(' ', padding) + '│');
    });
